...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        -- All open/close logic is here. DisplayFrame.InputBegan is unreliable because
        -- ToggleRegion (ZIndex 8) sits above DisplayFrame (ZIndex 6) and swallows clicks,
        -- and PickerFrameOuter (ZIndex 15, Active=true) does the same when open.
        -- InputService.InputBegan fires for ALL mouse input regardless of ZIndex.
        Library:GiveSignal(InputService.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                ...
                if overSwatch then
                    -- Toggle picker when clicking the color swatch
