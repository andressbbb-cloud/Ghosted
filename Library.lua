...
do
    ...
    function BaseAddonsFuncs:AddDropdown(Idx, Info)
        ...
        Info.Searchable = if typeof(Info.Searchable) == "boolean" then Info.Searchable else true
        ...
        -- DropdownInnerSearch removed: search box is now inside the dropdown list panel (ListSearchBox)
        ...
        local SEARCH_BOX_HEIGHT = Info.Searchable and (22 * DPIScale) or 0

        local function RecalculateListSize(YSize)
            local Y = YSize or math.clamp(GetTableSize(Dropdown.Values) * (20 * DPIScale), 0, MAX_DROPDOWN_ITEMS * (20 * DPIScale)) + 1
            ListOuter.Size = UDim2.fromOffset(ListOuter.Visible and OpenedXSizeForList or DropdownOuter.AbsoluteSize.X + 0.5, Y + SEARCH_BOX_HEIGHT)
        end
        ...
        if Info.Searchable then
            local ListSearchOuter = Library:Create("Frame", {
                BackgroundColor3 = Library.BackgroundColor;
                BorderColor3 = Library.OutlineColor;
                BorderMode = Enum.BorderMode.Inset;
            ...
            Library:AddToRegistry(ListSearchOuter, {
                BackgroundColor3 = "BackgroundColor";
                BorderColor3 = "OutlineColor";
            })

            ListSearchBox = Library:Create("TextBox", {
                BackgroundTransparency = 1;
                ...
                ZIndex = 23;
                Parent = ListSearchOuter;
            })

            Library:ApplyTextStroke(ListSearchBox)
            Library:AddToRegistry(ListSearchBox, {
                TextColor3 = "FontColor";
            })
        end
        ...
        local Scrolling = Library:Create("ScrollingFrame", {
            ...
            Position = UDim2.new(0, 0, 0, SEARCH_BOX_HEIGHT);
            Size = UDim2.new(1, 0, 1, -SEARCH_BOX_HEIGHT);
            ZIndex = 21;
            Parent = ListInner;
        ...
        function Dropdown:BuildDropdownList()
            ...
            for Idx, Value in next, Values do
                ...
                if Info.Searchable and not string.lower(StringValue):match(string.lower(ListSearchBox.Text)) then
                    continue
                end
