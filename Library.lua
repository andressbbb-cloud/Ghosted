    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        Library:GiveSignal(InputService.InputEnded:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                ...
                local overPicker = mx >= AbsPos.X and mx <= AbsPos.X + AbsSize.X and my >= AbsPos.Y and my <= AbsPos.Y + AbsSize.Y;
                local overSwatch = mx >= dpAbsPos.X and mx <= dpAbsPos.X + dpAbsSize.X and my >= dpAbsPos.Y and my <= dpAbsPos.Y + dpAbsSize.Y;
