...
do
    ...
    -- AddSearchDropdown: identical API to AddDropdown but with a live search/filter box
    function Funcs:AddSearchDropdown(Idx, Info)
        ...
        -- Outer panel that holds search box + list
        local ListOuter = Library:Create('Frame', {
            BorderColor3 = Color3.new(0, 0, 0);
            Position = UDim2.new(0, 4, 0, 20 + RelativeOffset + 1 + 20);
        ...
        -- Small magnifier icon
        local SearchIcon = Library:Create('ImageLabel', {
            AnchorPoint = Vector2.new(0, 0.5);
            BackgroundTransparency = 1;
            Position = UDim2.new(0, 3, 0.5, 0);
            Size = UDim2.new(0, 14, 0, 14);
            Image = 'rbxassetid://3926305904'; -- magnifying glass
        ...
        -- ── Scrolling list (below the search box) ───────────────────
        local Scrolling = Library:Create('ScrollingFrame', {
            BackgroundTransparency = 1;
            CanvasSize = UDim2.new(0, 0, 0, 0);
        ...
        -- Keeps track of all button tables so we can refresh highlights
        local AllButtons = {};
                    ...
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                        ...
                        if Dropdown:GetActiveValues() == 1 and (not Try) and (not Info.AllowNull) then
                            ...
                            if Info.Multi then
                                ...
                                -- deselect all other visible buttons
        ...
        function Dropdown:OpenDropdown()
            ...
            Library.OpenedFrames[ListOuter] = true;
            DropdownArrow.Rotation = 180;
            -- Focus the search box so user can type immediately
